...
namespace Moonglade.Configuration
{
  ...
  public class SocialProfileSettings : IBlogSettings
  {
    ...
    [JsonIgnore]
    public static SocialProfileSettings DefaultValue =>
        new()
        {
          GpgKeyUrl = string.Empty,
          Twitter = string.Empty,
          Mastodon = string.Empty,
          ...
          Steam = string.Empty,
          Stackoverflow = string.Empty,
          DevTo = string.Empty,
          Codersrank = string.Empty,
          AmazonAuthorPage = string.Empty,
          LastFm = string.Empty,
          CodeProject = string.Empty,
          Matrix = string.Empty,
          OpenHub = string.Empty,
          CodeStats = string.Empty,
          KeyBase = string.Empty,
          BuyMeACoffee = string.Empty,
          AmazonWishlist = string.Empty,
          Paypal = string.Empty,
          Patreon = string.Empty,
          Liberapay = string.Empty
        };
  }
}
