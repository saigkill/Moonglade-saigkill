...
var CodersRankActivity = /*#__PURE__*/function (_HTMLElement) {
  ...
  _proto.tooltipText = function tooltipText(date) {
    ...
    return "\n        <div class=\"codersrank-activity-tooltip-header\">\n          " + formatter.format(new Date(date)) + " - <b>" + activities + " activities</b>\n        </div>\n        <ul class=\"codersrank-activity-tooltip-list\">\n          " + (data.github ? "\n          <li><i>" + _icons.icons.github + "</i>" + data.github + " activities</li>\n          " : '') + "\n          " + (data.gitlab ? "\n          <li><i>" + _icons.icons.gitlab + "</i>" + data.gitlab + " activities</li>\n          " : '') + "\n          " + (data["private"] ? "\n          <li><i>" + _icons.icons.folder + "</i>" + data["private"] + " activities</li>\n          " : '') + "\n          " + (data.stackoverflow ? "\n          <li><i>" + _icons.icons.stackoverflow + "</i>" + data.stackoverflow + " activities</li>\n          " : '') + "\n        </ul>\n      ";
  };
