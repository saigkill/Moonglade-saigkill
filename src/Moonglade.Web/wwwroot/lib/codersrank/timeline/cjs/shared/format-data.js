...
var formatData = function formatData(items, type) {
  ...
  items.forEach(function (item, index) {
    var itemStartDate = new Date(item.start_date);
    var itemEndDate = item.is_current ? new Date() : new Date(item.end_date);
    var itemStartCol = (0, _differenceInMonths.differenceInMonths)(startDate, itemStartDate);
    var itemEndCol = itemStartCol + (0, _differenceInMonths.differenceInMonths)(itemStartDate, itemEndDate);
