...
var CodersrankPortfolio = /*#__PURE__*/function (_HTMLElement) {
  ...
  _proto.loadAndRender = function loadAndRender() {
    ...
    this.render();
    (0, _fetchData.fetchData)(username).then(function (portfolio) {
      _this2.data = (0, _formatData.formatData)(portfolio, _this2.maxItems);
...
module.exports = CodersrankPortfolio;
