...
namespace Moonglade.Web.Helpers
{
    public static class PostModelExtensions
    {
        ...
        public static TimeToRead GetTimeToRead(this Post story, IStringLocalizer<SharedResource> localizer)
        {
            ...
            string strMinutes = (minutes == 1) ? localizer["Minute"] : localizer["Minutes"];
            string strSeconds = (seconds == 1) ? localizer["Second"] : localizer["Seconds"];
