...
public record MigrationResult(MigrationStatus Status, string ErrorMessage = null, System.Version FromVersion = null, System.Version ToVersion = null)
{
    ...
    IHttpClientFactory httpClientFactory) : IMigrationManager
{
    ...
    private bool TryParseVersions(out System.Version manifestVersion, out System.Version currentVersion, out string error)
    {
        manifestVersion = null!;
        currentVersion = null!;

        if (!System.Version.TryParse(blogConfig.SystemManifestSettings.VersionString, out manifestVersion))
        {
            error = $"Invalid manifest version string: {blogConfig.SystemManifestSettings.VersionString}";
            return false;
        }

        if (!System.Version.TryParse(VersionHelper.AppVersionBasic, out currentVersion))
        {
    ...
    private static bool ShouldMigrate(System.Version manifestVersion, System.Version currentVersion)
    {
