    ...
    IHttpClientFactory httpClientFactory) : IMigrationManager
{
  public async Task TryMigration(BlogDbContext context)
  {
    ...
    var manifestVersion = System.Version.Parse(blogConfig.SystemManifestSettings.VersionString);
    var currentVersion = System.Version.Parse(Helper.AppVersionBasic);
